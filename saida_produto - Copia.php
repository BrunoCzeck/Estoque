	...
	<li class="nav-item">
		...
		<div class="form-group">
					...
					<select class="form-control" name="selOrg">
						...
						if($organizacao == '1'):
							echo "<option value='$organizacao'>Dasa</option>";						
							if($organizacao == '2'):						
								echo "<option value='$organizacao'>Sicredi</option>";						
								elseif($organizacao == '3') : 
									echo "<option value='$organizacao'>Sicoob</option>";			
							endif;
						endif;
						
						echo "<option value='$organizacao'>$organizacao</option>";
						echo "<option value=''>------------------- </option>";
						while ($row_org = mysqli_fetch_array($result_org)) {
							$organizacao = $row_org['nome_categoria'];
							echo "<option value='$organizacao'>$organizacao</option>";
						}
						?> 
